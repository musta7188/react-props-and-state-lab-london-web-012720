...
// //       expect(wrapper.text().includes(name)).to.be.true;
// //     });
...
// //       const wrapper = shallow(<Pet pet={FEMALE_CAT} />);
// //       expect(wrapper.text().includes(type)).to.be.true;
// //     });

// //     it('should render the pet age', () => {
// //       const wrapper = shallow(<Pet pet={FEMALE_CAT} />);
// //       expect(wrapper.text().includes(age)).to.be.true;
// //     });

// //     it('should render the pet weight', () => {
// //       const wrapper = shallow(<Pet pet={FEMALE_CAT} />);
// //       expect(wrapper.text().includes(weight)).to.be.true;
// //     });
// //   });
